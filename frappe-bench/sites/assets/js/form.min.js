...
_f.Frm.prototype.render_form=function(){if(!this.meta.istable){this.refresh_header();this.sidebar=new frappe.ui.form.Sidebar({frm:this,page:this.page});this.script_manager.trigger("refresh");$(document).trigger('form_refresh');this.refresh_fields();if(this.cscript.is_onload){this.script_manager.trigger("onload_post_render");}
